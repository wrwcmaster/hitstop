...
defineLocale('zh', {
  ...
  strings: {
    ...
    'PARRY!': '格挡!',
    'RAMPARTS': '城墙',
    /* ---- the Eastgate, and the pass beyond it ---- */
    'THE EASTGATE': '东门',
    'The Eastgate': '东门',
    'WINDSWEPT ASCENT': '风蚀登道',
    'Windswept Ascent': '风蚀登道',
    'CLIFFSIDE PASSAGE': '崖侧通道',
    'Cliffside Passage': '崖侧通道',
    'Somebody stacked this. Course by course, against something.': '这是有人一层层垒起来的。为了挡住什么。',
    'The town keeps its grass because the wall keeps the wind. Past the arch it is all mountain.': '城墙挡住了风,镇上才留得住青草。拱门之外,便只剩山了。',
    'THE DUELIST': '决斗者',
    'EN GARDE!': '预备!',
    'The wall walk. The town below sleeps because she paces here.': '城墙步道。她在此巡行,城下才能安眠。',
    'The Duelist. Saber and sidearm. Watch the glint - it always fires after the glint.': '决斗者。马刀与手枪。盯住那道寒光——枪声总在寒光之后。',
    'And when she blurs, knight... do not be where you were.': '当她化作残影时,骑士……千万别留在原地。',
    'The saber drops. She salutes with an empty hand and is gone.': '马刀坠地。她以空手行礼,随即消失。',
    ...
    'VISE-ARENA': '钳兽竖井',
    'RIVEN-FLUE': '裂隙烟道',
    'The floor gives, and the world opens downward.': '地面塌陷,世界向下敞开。',
    'Cold blue, hanging chains, and walls that go up further than they go down.': '幽蓝、垂链,而墙壁向上延伸得比向下更远。',
    'Something is climbing them. It makes it look easy.': '有东西正在攀爬。看上去轻而易举。',
    'The nest matter thickens until the stone is more nest than stone.': '巢质越积越厚,石壁已不像石壁,倒像巢穴。',
    'Below: a shaft, four ledges, and nothing else to stand on.': '下方:一道竖井,四处岩台,再无立足之地。',
    'Whatever holds these walls has never needed a floor.': '攫住这些墙壁的东西,从不需要地板。',
    'The last grip fails. It falls the way anything falls.': '最后一处抓握失守。它像万物一样坠落。',
    'The walls are only walls now — and your hands finally know what to do with them.': '墙壁如今只是墙壁——而你的双手,终于懂得该拿它们怎么办。',
    ...
    'MAGE': '法师',
    'TIDECALLER': '唤潮者',
    'Steel and stubbornness. Hits harder, stands longer.': '钢铁与执拗。出手更重,站得更久。',
    'The arcane path. Deep mana, learned nova, thin armor.': '奥术之路。法力深厚,习得新星,甲胄单薄。',
    'The drowned path. Fast on land, faster below.': '沉水之路。陆上迅捷,水下更快。',
    'STEEL': '钢铁',
    'VALOR': '勇气',
    'ARCANA': '奥术',
    'FROST': '霜寒',
    ...
    'WIND': '疾风',
    'COLOSSUS': '巨人',
    '+2 max HP and +1 attack': '+2 生命上限,+1 攻击',
    'RIME WELL': '霜之泉',
    'GLACIAL SKIN': '冰肤',
    "WINTER'S EDGE": '凛冬之刃',
    '+1 attack, frost-sharpened': '+1 攻击,经霜磨砺',
    'OTTER BLOOD': '水獭之血',
    '+1 max HP, stronger strokes': '+1 生命上限,划水更有力',
    'FLEET FOOT': '疾行',
    'Run 15% faster': '跑速提升 15%',
    'GALE DASH': '风驰',
    'Dash cooldown nearly halved': '冲刺冷却近乎减半',
    'Already your calling': '这已是你的天命',
    '{name} now walks this road': '{name}踏上了这条路',
    'Change class to walk this path': '先转职,方能走这条路',
    'Already learned': '早已习得',
    'Learn the node above first': '先学会上面的节点',
    '{name} LEARNED!': '习得{name}!',
    'Not enough skill points': '技能点不足',
    'Z: become a {name}': 'Z:转职为{name}',
    'Z: learn - up: class - Esc: back': 'Z:学习 - 上:职业 - Esc:返回',
    'TIDE BREAKER': '破浪',
    ...
    'HASTE DRAUGHT': '疾速药剂',
    'HUNTING BOW': '猎弓',
    'Arrows arc. Lead your mark.': '箭矢成弧。提前量,瞄准目标。',
    'FLINTLOCK': '燧发枪',
    'One loud argument, slowly reloaded.': '一声巨响定胜负,装填缓慢。',
    'GATE KEY': '大门钥匙',
