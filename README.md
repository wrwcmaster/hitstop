...
**Ranged combat:** buy the **HUNTING BOW** or the **FLINTLOCK** from the merchant — arrows leave at real muzzle speed and *arc* under gravity (hold ↑ to loose at 45°, ↓ mid-air for a steep shot; lead your targets), while the flintlock cracks a fast, nearly-flat bullet with a real kick and a slow reload. The monsters shoot back: **archers** in the cavern lob solver-aimed arrows (the draw-back is your warning), and **gunners** level a glinting musket before firing. Both drop their weapons, rarely.
