...
**Water:** the **Drowned Grotto** (through the mid-cavern gate, or the portal) is a flooded cavern — float at the surface, stroke with jump, hold down to dive, and watch your air bubbles: lungs empty means your health starts going. Air pockets trapped under rock refill your breath mid-dive. Mind the **pikes** — they only hunt what swims — and crack open the sunken **treasure chests** if you can hold your breath long enough. The skill tree's new tide tier (**DEEP LUNGS**) doubles down on diving.

**Parry & riposte:** tap **F** (or gamepad RT) to raise a guard for a heartbeat. Time it as a blow lands and you *deflect* it — no damage taken, the attacker staggered, and a golden **riposte** window opens where your next swing hits harder. Guard an incoming **arrow or bullet** and you knock it right back at whoever fired it. It's the intended answer to the Duelist's blade and the archers' volleys — timing over tanking.

**A human boss — the Duelist:** climb the archway on Haven's left platform to the moonlit **Ramparts**, where a fallen knight in crimson waits with a saber in one hand and a flintlock in the other. She fences at a real measure — lunge combos up close, a backstep that flows into a pistol shot, and *the blur*, an afterimage dash straight through you with steel out. At half health she calls "EN GARDE!" and adds an aerial bullet volley. Beat her and her sidearm is yours.

**Ranged combat:** buy the **HUNTING BOW** or the **FLINTLOCK** from the merchant. The bow is *drawn*, not clicked — **hold** attack to pull the string and **release** to loose: the length of the draw decides how fast, hard, and far the arrow flies (a tap is a weak close lob; the golden flash means fully drawn). Arrows *arc* under gravity (hold ↑ to loose at 45°, ↓ mid-air for a steep shot; lead your targets), while the flintlock cracks a fast, nearly-flat bullet on the press, with a real kick and a slow reload. The monsters shoot back: **archers** in the cavern lob solver-aimed arrows (the draw-back is your warning), and **gunners** level a glinting musket before firing. Both drop their weapons, rarely.

**Classes:** pick your road in the SKILL TREE screen (Esc → SKILL TREE, then up to the class tabs) — **KNIGHT** (harder hits, more health, dash strike), **MAGE** (deep mana, learned NOVA, frost tricks), or **TIDECALLER** (faster on land, double jump, gale dash, and the deep-water tier). Each class has its own small skill tree; switching is free and keeps every class's unlocks parked for your return, with skill points as one shared pool — so experiment, don't grind.

**Puzzles:** the **Town Vault** (a heavy door on Haven's east edge) is the old kings' trap-gauntlet — **spike pits** that bite a chunk of health and launch you clear, **moving platforms** that carry you over them, a **lever** that latches a barrier open, and a **pressure plate** whose barrier only *lingers* a few seconds after you step off: press it, then sprint. Three treasure chests wait at the end. All of it is data — platforms, levers, plates, and barriers are placeables wired by named switch flags, so the level editor can build new puzzles with zero code.
